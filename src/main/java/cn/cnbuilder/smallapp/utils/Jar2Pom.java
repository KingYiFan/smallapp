...
public class Jar2Pom {
    ...
    public static void main(String[] args) {
        ...
        File libs = new File("E:\\FHADMINM\\WebRoot\\WEB-INF\\lib");
        for (File jar : libs.listFiles()) {
            ...
            if (!getPomByChecksum(jar).isTextOnly()) {
                try {
                    ...
                    PrintWriter pw = new PrintWriter(new FileWriter("C:\\Users\\69673\\Desktop\\pom.xml"));
                    pw.write(getPomByChecksum(jar).asXML());
                ...
                try {
                    ...
                    PrintWriter pw = new PrintWriter(new FileWriter("C:\\Users\\69673\\Desktop\\pom.xml"));
                    pw.write(getPomByManifest(jar).asXML());
                    pw.close();
                } catch (Exception e) {
                    e.printStackTrace();
                }
